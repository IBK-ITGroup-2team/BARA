...
#IBK, 하나, 국민, 농협, 신한, 우리
url = ['https://play.google.com/store/apps/details?id=com.ibk.scbs', 'https://play.google.com/store/apps/details?id=com.hanabank.ebk.channel.android.cpb',
       'https://play.google.com/store/apps/details?id=com.kbstar.kbbiz', 'https://play.google.com/store/apps/details?id=nh.smart.ncbank',
       'https://play.google.com/store/apps/details?id=com.shinhan.sbizbank', 'https://play.google.com/store/apps/details?id=com.wooribank.smart.biz']
csv = ['./reviews/기업고객/IBKreview_dataset(iONEBank기업).csv', './reviews/기업고객/HANA_enterprise_review_dataset.csv',
       './reviews/기업고객/KBreview_dataset(KB스타기업뱅킹).csv', './reviews/기업고객/NHreview_dataset(NH기업뱅킹).csv',
       './reviews/기업고객/SHINHANbank_enterprise_review_dataset.csv', './reviews/기업고객/WOORIbank_enterprise_review_dataset.csv']
total_rating = ['./reviews/별점/IBKreview_rating(iONEBank기업).csv', './reviews/별점/HANA_enterprise_review_rating.csv',
       './reviews/별점/KBreview_rating(KB스타기업뱅킹).csv', './reviews/별점/NHreview_rating(NH기업뱅킹).csv',
       './reviews/별점/SHINHANbank_enterprise_review_rating.csv', './reviews/별점/WOORIbank_enterprise_review_rating.csv']
